...
$(document).ready(function(){
    ...
    var _btnNew='<button class="btn btn-white btn-sm"  id="btn-new" data-toggle="tooltip" data-placement="left" title="Create New Consumer" ><i class="fa fa-users"></i> Create New Consumer</button>';
